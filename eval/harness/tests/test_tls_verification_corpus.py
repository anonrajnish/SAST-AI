"""Integrity tests for the committed disabled-TLS-verification curated corpora (CWE-295)."""
...
_CORPORA = {
    "tls_verification_py": "python",
    "tls_verification_js": "javascript",
}


@pytest.mark.parametrize("corpus_id", sorted(_CORPORA))
def test_tls_verification_corpus_loads_and_validates(corpus_id: str) -> None:
    ...
    assert {label.cwe for label in label_set.labels} == {"CWE-295"}
